    ...
    if( $(".start_hour").val() == "" ){
	    ...
	    //===========================================  
	     $(".allDay").click(function(){	
	        ...
	        var year = s_d.substr(0,4);
	        var month = s_d.substr(5,2);
	        var date = s_d.substr(8,2);
	        year = parseInt(year,10);
	        month = parseInt(month,10);
	        date = parseInt(date,10);
	        
	        var day = new Date( year,month-1,date+1  );
	        var yearClone = day.getFullYear();
	        var monthClone = day.getMonth() + 1;
	        var dateClone = day.getDate();

	        var xxx = yearClone + "-" + monthClone + "-" + dateClone;
